    ...
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <div class="white-box">
                            ...
                            <form class="form-horizontal form-material" action="{{url('admin/partners/'.$partner->id)}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="{{$partner->name}}" class="form-control form-control-line" name="name" >
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group {{ $errors->has('content') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <textarea rows="10" class="form-control form-control-line my-editor" name="content">{!! $partner->byLocale()->content !!}</textarea>

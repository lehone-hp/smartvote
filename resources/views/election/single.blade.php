                ...
                @foreach($election->candidates as $candidate)
                    <div class="col-xl-3 col-md-4 col-sm-6 mb-2">
                        ...
                        <div class="card border-left-primary shadow h-100 ">
                            <div class="card-body add-vote pointer">
                                <input type="hidden" class="can-id" value="{{ $candidate->id }}">
                                <div class="row no-gutters align-items-center">
                                    <div class="sno text-primary">{{ $loop->index + 1 }}</div>
                                    <div class="col-md-6 col-sm-6 mr-2">
                                        ...
                                        <div id="candidate_{{ $candidate->id }}"
                                             class="h3 mb-0 vote-count font-weight-bold text-gray-800">{{ $candidate->votes }}</div>
                                    </div>
                                    <div class="col-md-4 col-sm-4">
                                            <img src="{{ route('candidate.photo', ['photo'=>$candidate->photo]) }}"
                                                 class="pointer" style="height: 77.15px; width: 77.15px ;" >
                                    </div>
                                </div>
                            </div>
                        </div>
